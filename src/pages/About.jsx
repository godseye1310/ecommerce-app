			...
			<section id="about" className="max-w-[900px] my-0 mx-auto text-lg overflow-hidden p-2">
				...
				<div className="">
					...
					<p className=" m-5 text-[#777] max-xs:text-sm">
						...
						right enjoyed by corrupt, are accusing him of all pleasures, and seek his own, or, to
						...
						importance to us that these are consequent to that question is answered, which was
						selected for the fault, it is often one of us, however, have any! Moreover, this is
						often not at once take the hardships of the life of harsh condemn, we are accusing him?
